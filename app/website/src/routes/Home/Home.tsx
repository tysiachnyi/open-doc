  ...
  return (
    <div className="bg-slate-100 flex items-center justify-center p-10">
      <div className="text-gray-800 text-2xl">
        ...
        <p className="mb-6">
          <span className="text-blue-500">OPEN-DOC</span> is a powerful and
          intuitive documentation creation app. It helps you streamline the
          process of creating, organizing, and sharing documentation for your
          projects or products. Whether you are a developer, team lead, or
          product manager,{" "}
